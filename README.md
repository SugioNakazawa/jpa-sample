...
Hibernate: 
    ...
    for
        ...
        */insert 
    into
        users (age, created_at, email, updated_at, username) 
    values
        (?, ?, ?, ?, ?)
11月 25, 2025 5:09:57 午後 org.hibernate.engine.jdbc.spi.SqlExceptionHelper logExceptions
WARN: HHH000247: ErrorCode: 0, SQLState: null
11月 25, 2025 5:09:57 午後 org.hibernate.engine.jdbc.spi.SqlExceptionHelper logExceptions
WARN: Unsupported autoGeneratedKeys
Exception in thread "main" org.hibernate.exception.GenericJDBCException: Could not prepare statement [Unsupported autoGeneratedKeys] [/* insert for com.example.entity.User */insert into users (age,created_at,email,updated_at,username) values (?,?,?,?,?)]
